...
Leader_Total <- temp %>% top_n(10,Total) %>% arrange(desc(Total)) %>% select(Player,Round,Opposition,Total)
...
pngTable(head(Leader_Total,10),filename='C:/Users/karl.jackson/dropbox/fitzroyfc.github.io/Game Records - Total.png',hc=1,ht=400,wt=500)
